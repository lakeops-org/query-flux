...
To add or drop platforms, edit `IMAGE_PLATFORMS` in [docker-release-rc.yml](.github/workflows/docker-release-rc.yml) and [docker-release-prod.yml](.github/workflows/docker-release-prod.yml).
