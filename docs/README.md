...
| [adding-engine-support.md](adding-engine-support.md) | Checklist for new **backend engines** (Rust adapters), **Studio** (TypeScript registry/forms), and **frontend wire protocols** (e.g. Postgres wire). |
